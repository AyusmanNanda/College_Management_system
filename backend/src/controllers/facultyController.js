    ...
    try {
        const result = await db.query(`
            SELECT
                ...
                f.qualification,
                f.experience,
                TO_CHAR(f.birthdate, 'YYYY-MM-DD') AS birthdate,
                f.gender,
                f.courcecode,
...
exports.updateFaculty = async (req, res) => {
    ...
    try {
        ...
        const rowsResult = await db.query(
            "SELECT facultyid, profilepic FROM faculties WHERE sr_no = $1",
            [id]
        );
...
exports.deleteFaculty = async (req, res) => {
    ...
    try {
        const rowsResult = await db.query(
            "SELECT profilepic FROM faculties WHERE sr_no = $1",
            [id]
        );
        ...
        await db.query(
            "DELETE FROM faculties WHERE sr_no = $1",
            [id]
        );
...
exports.changeFacultyPassword = async (req, res) => {
    try {
        ...
        await db.query(
            "UPDATE faculties SET password = $1 WHERE sr_no = $2",
            [
                hashed,
                faculty.sr_no
            ]
...
exports.changeFacultyEmail = async (req, res) => {
    try {
        ...
        await db.query(
            "UPDATE faculties SET emailid = $1 WHERE sr_no = $2",
            [
                newEmail,
                rows[0].sr_no
            ]
