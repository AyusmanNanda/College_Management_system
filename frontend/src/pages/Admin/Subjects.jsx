                ...
                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 shadow-sm">
                    ...
                    <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 w-full">
                        <input
                            ...
                            className={`px-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-gray-400 dark:focus:ring-gray-500 transition ${
                                editingCode ? "bg-gray-100 dark:bg-gray-600 cursor-not-allowed" : ""
                            }`}
                        />
                        ...
                        <select
                            ...
                            onChange={handleFormChange}
                            className="px-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-md text-sm transition"
                        >
                                    ...
                                    <td className="p-4">
                                        <div className="flex flex-col sm:flex-row gap-2">
                                            <button
                                                ...
                                                className="w-full sm:w-auto px-3 py-1 text-xs sm:text-sm bg-gray-200 dark:bg-gray-600 dark:text-gray-100 rounded hover:bg-gray-300 dark:hover:bg-gray-500 transition"
                                            >
                                                Edit
                                            </button>
                                            <button
                                                ...
                                                className="w-full sm:w-auto px-3 py-1 text-xs sm:text-sm bg-red-600 text-white rounded hover:bg-red-700 transition"
                                            >
                                                Delete
                                            </button>
                                        </div>
